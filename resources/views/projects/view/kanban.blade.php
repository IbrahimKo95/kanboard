            ...
            <div class="w-80 flex-none">
                ...
                <div class="task-list space-y-4" data-column-id="{{ $column->id }}">
                    @foreach($column->tasks as $task)
                        <div class="task bg-white p-4 rounded-xl border {{ !\Carbon\Carbon::parse($task->due_date)->isPast() || !isset($task->due_date) ? "border-gray-200" : "border-red-400"}} shadow-sm cursor-move" draggable="true" data-task-id="{{ $task->id }}">
